		...
		_glTypeFor: {
			value: function (type, componentType) {
				if ( typeof type != "string" )
					return (type) ;
				switch ( type ) {
					case "SCALAR": return (componentType) ;
					case "VEC2":
						switch ( componentType ) {
							case WebGLRenderingContext.BOOL: return (BOOL_VEC2) ;
							case WebGLRenderingContext.INT: return (WebGLRenderingContext.INT_VEC2) ;
							case WebGLRenderingContext.FLOAT: return (WebGLRenderingContext.FLOAT_VEC2) ;
						}
						break ;
					case "VEC3":
						switch ( componentType ) {
							case WebGLRenderingContext.BOOL: return (BOOL_VEC3) ;
							case WebGLRenderingContext.INT: return (WebGLRenderingContext.INT_VEC3) ;
							case WebGLRenderingContext.FLOAT: return (WebGLRenderingContext.FLOAT_VEC3) ;
						}
						break ;
					case "VEC4":
						switch ( componentType ) {
							case WebGLRenderingContext.BOOL: return (BOOL_VEC4) ;
							case WebGLRenderingContext.INT: return (WebGLRenderingContext.INT_VEC4) ;
							case WebGLRenderingContext.FLOAT: return (WebGLRenderingContext.FLOAT_VEC4) ;
						}
						break ;
					case "MAT2":
						switch ( componentType ) {
							case WebGLRenderingContext.FLOAT: return (WebGLRenderingContext.FLOAT_MAT2) ;
						}
						break ;
					case "MAT3":
						switch ( componentType ) {
							case WebGLRenderingContext.FLOAT: return (WebGLRenderingContext.FLOAT_MAT3) ;
						}
						break ;
					case "MAT4":
						switch ( componentType ) {
							case WebGLRenderingContext.FLOAT: return (WebGLRenderingContext.FLOAT_MAT4) ;
						}
						break ;
					case "SAMPLE_2D": return (WebGLRenderingContext.SAMPLE_2D) ;
					case "SAMPLER_CUBE": return (WebGLRenderingContext.SAMPLER_CUBE) ;
				}
            ...
            value: function(entryID, description, userInfo) {
                ...
                for (var i = 0 ; i < primitivesDescription.length ; i++) {
                    ...
                    if (primitiveDescription.primitive === WebGLRenderingContext.TRIANGLES) {
						...
						if ( typeof indicesObject.type == "string"  && indices.description.hasOwnProperty ("componentType") )
							indicesObject.type =this._glTypeFor (indicesObject.type, indices.description.componentType) ;
                        ...
                        allAttributes.forEach( function(semantic) {
							...
							if ( typeof attributeObject.type == "string"  && attribute.hasOwnProperty ("componentType") )
								attributeObject.type =this._glTypeFor (attributeObject.type, attribute.componentType) ;
